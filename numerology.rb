puts "Morpheous, I know your fate: Do you want the red or blue pill? Nah, just tell me your birth date (MMDDYYYY)!"
birthdate = gets
puts "Thanks! Your birth date is #{birthdate}."
number = birthdate[0].to_i + birthdate[1].to_i+ birthdate[2].to_i+ birthdate[3].to_i+ birthdate[4].to_i+ birthdate[5].to_i+ birthdate[6].to_i+ birthdate[7].to_i
number = number.to_s

single_number = number[0].to_i + number[1].to_i
if single_number > 9
	single_number = single_number[0].to_i + single_number[1].to_i
end
single_number = single_number.to_s
single_number
...
when '9'
	...
	puts "The astrology doesn't work. You are not from this solar system! Goodbye!"
end
